...
#price = data[['Close', 'Open', 'Vol']]
price = data[['Close', 'Open', 'Vol', 'Amount']]
print(price.info())
...
price['Vol'] = scaler.fit_transform(price['Vol'].values.reshape(-1, 1))
price['Amount'] = scaler.fit_transform(price['Amount'].values.reshape(-1, 1))
print(price.shape)
